...
class TTextTheme{
  ...
  static TextTheme darkTextTheme = const TextTheme(
    ...
    titleSmall: TextStyle(fontSize: 18 , fontWeight: FontWeight.w400 , color: Colors.white),
    ...
    labelMedium: TextStyle(fontSize: 14 , fontWeight: FontWeight.normal , color: Colors.white),
  );
}