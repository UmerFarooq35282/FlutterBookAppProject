...
class AddAuthorsPage extends StatefulWidget {
  const AddAuthorsPage({super.key});

  @override
  State<AddAuthorsPage> createState() => _AddAuthorsPageState();
}

class _AddAuthorsPageState extends State<AddAuthorsPage> {
  List categories = [];
  ...
  Future<http.Response> _getCategories() async {
    final http.Response response =
        await Network().postData({"O": "0", "S": "40"}, '/getCategories.php');
  ...
  Future<http.Response> _addAuthors() async {
